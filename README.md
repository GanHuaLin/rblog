...
+ 我想用 ES6 来写我的代码，我想用组件化的方式来组织我的页面结构

+ 我不会 Ruby 不会 Go

+ 我想实现喜欢的博客样式而不是只能用其他人的主题

+ Hexo 的自定义主题也尝试过，由于有一些限制和使用 ejs 之类的 Dynamic Web 不是我想要的

+ 我觉得用 markdown 写文章很酷，文章即数据，数据即文件

+ markdown 文件几乎很少改动或者不改动，立马就可以直接放笔记软件或者简书那样支持 markdown 的网站

+ 再好的富文本编辑器只能解决丰富的文本编辑需求，却无法给你带来纯字符编辑的乐趣

+ 我想要了解 Next.js

虽然我很努力的在"编"各种理由，但上面一条是认真的 :monkey_face:
