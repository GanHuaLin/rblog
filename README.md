...
+ Hexo 的自定义主题也尝试过，由于有一些限制和使用 ejs 之类的 Dynamic Web 技术不是我想要的

+ 我喜欢静态站点作为博客的点子，不需要数据库，不需要 Dynamic Web Page 逼自己学会打蚊子不要用高射炮
...
该项目用于个人学习和使用，希望大家喜欢并且使用

但是不接受 pull request 如果你对该项目感兴趣并且有任何新的想法和需求可以自行 fork 之后自由发挥 
